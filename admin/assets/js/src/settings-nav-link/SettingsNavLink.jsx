...
const SettingsNavLink = () => {
    ...
    return(                                                         
      ...
      <Link  to={'admin.php?page=saswp&path=settings_compatibility'} className={current == 'settings_compatibility' ? 'tab-item active' : 'tab-item'}>{__('Compatibility', 'schema-and-structured-data-for-wp')}</Link>                                
