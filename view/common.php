                    ...
                    if($schema_type == 'ItemList'){
                     ...
                     foreach($type_fields as $key => $value){
                            ...
                            if($value == 'product_pros'){
                                ...
                                $tabs_fields .= '<a itemlist_sub_type="'.esc_attr($itemlist_sub_type).'" data-id="'.esc_attr($schema_id).'" div_type="'.$key.'" fields_type="'.$value.'" class="button saswp_add_schema_fields_on_fly saswp-'.$key.'">'.esc_html__( 'Add '.$btn_text ).'</a>';   
                            }                                                                                                  
                            $tabs_fields .= '</div>';                                                                                                
