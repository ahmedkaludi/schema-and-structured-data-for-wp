        ...
        <div class="misc-pub-section">
            ...
            <div class="saswp-schema-type-section">
                ...
                <tr class="saswp-organization-type-tr" <?php echo $style_business_type; ?>>
                    <td>
                    <?php echo esc_html__('Organization Type', 'schema-and-structured-data-for-wp', 'schema-and-structured-data-for-wp' ); ?>    
                    </td>
                    <td>
