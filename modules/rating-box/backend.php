...
class saswp_rating_box_backend {
 ...
 private $screen = array();
        ...
        public function saswp_rating_box_appearance()
        {
            ...
            ob_start();
        ?>
            <div class="saswp-rbcc-fields <?php echo esc_attr($hide_class); ?>">
                        ...
                        <tbody>
                            <tr class="saswp-rbcc-tr-row">
                                ...
                                <td class="saswp-rbcc-td-attributes">
                                    ...
                                    <input type="text" name="sd_data[saswp-rbcc-review-bg-color]" id="saswp-rbcc-review-bg-color" class="saswpforwp-colorpicker" data-alpha-enabled="false"  value="<?php echo isset( $sd_data['saswp-rbcc-review-bg-color'] ) ? esc_attr( $sd_data['saswp-rbcc-review-bg-color']) : '#000'; ?>" data-default-color="#000">
                                </td>
                                <td class="saswp-rbcc-td-attributes">
                                    <div><?php echo saswp_t_string('Font Color'); ?></div>
                                    <input type="text" name="sd_data[saswp-rbcc-review-f-color]" id="saswp-rbcc-review-f-color" class="saswpforwp-colorpicker" data-alpha-enabled="false"  value="<?php echo isset( $sd_data['saswp-rbcc-review-f-color'] ) ? esc_attr( $sd_data['saswp-rbcc-review-f-color']) : '#fff'; ?>" data-default-color="#fff">
                                </td>
                                <td class="saswp-rbcc-td-attributes">
                                    <div><?php echo saswp_t_string('Font Size'); ?></div>
                                    <input type="number" name="sd_data[saswp-rbcc-review-f-size]" id="saswp-rbcc-review-f-size" class="saswp-rbcc-review-input-num" value="<?php echo isset( $sd_data['saswp-rbcc-review-f-size'] ) ? esc_attr( $sd_data['saswp-rbcc-review-f-size']) : '15'; ?>">
                                    ...
                                    foreach ($unit_array as $ukey => $uvalue) {
                                        $selected_value = isset($sd_data['saswp-rbcc-review-f-unit'])?$sd_data['saswp-rbcc-review-f-unit']:'';
                            ...
                            <tr class="saswp-rbcc-tr-row">
                                ...
                                <td class="saswp-rbcc-td-attributes">
                                    ...
                                    <input type="text" name="sd_data[saswp-rbcc-if-color]" id="saswp-rbcc-if-color" class="saswpforwp-colorpicker" data-alpha-enabled="false"  value="<?php echo isset( $sd_data['saswp-rbcc-if-color'] ) ? esc_attr( $sd_data['saswp-rbcc-if-color']) : '#000'; ?>" data-default-color="#000">
                                </td>
                                <td class="saswp-rbcc-td-attributes"> 
                                    <div><?php echo saswp_t_string('Size'); ?></div>
                                    <input type="number" name="sd_data[saswp-rbcc-if-f-size]" id="saswp-rbcc-if-f-size" class="saswp-rbcc-review-input-num" value="<?php echo isset( $sd_data['saswp-rbcc-if-f-size'] ) ? esc_attr( $sd_data['saswp-rbcc-if-f-size']) : '18'; ?>">
                                    <select name="sd_data[saswp-rbcc-if-f-unit]" id="saswp-rbcc-if-f-unit">
                                        <?php 
                                        $unit_array = array('px', 'pt', '%', 'em');
                                        foreach ($unit_array as $ukey => $uvalue) {
                                            $selected_value = isset($sd_data['saswp-rbcc-if-f-unit'])?$sd_data['saswp-rbcc-if-f-unit']:'';
                                            if($uvalue == $selected_value){
                                            ?>
                                                <option value="<?php echo esc_attr($uvalue);?>" selected><?php echo esc_html($uvalue);?></option>    
                                            <?php    
                            ...
                            <tr class="saswp-rbcc-tr-row">
                                ...
                                <td class="saswp-rbcc-td-attributes">
                                    <div><?php echo saswp_t_string('Color'); ?></div>
                                    <input type="text" name="sd_data[saswp-rbcc-ar-color]" id="saswp-rbcc-ar-color" class="saswpforwp-colorpicker" data-alpha-enabled="false"  value="<?php echo isset( $sd_data['saswp-rbcc-ar-color'] ) ? esc_attr( $sd_data['saswp-rbcc-ar-color']) : '#000'; ?>" data-default-color="#000">
                                </td>
                                <td class="saswp-rbcc-td-attributes"> 
                                    <div><?php echo saswp_t_string('Size'); ?></div>
                                    <input type="number" name="sd_data[saswp-rbcc-ar-f-size]" id="saswp-rbcc-ar-f-size" class="saswp-rbcc-review-input-num" value="<?php echo isset( $sd_data['saswp-rbcc-ar-f-size'] ) ? esc_attr( $sd_data['saswp-rbcc-ar-f-size']) : '48'; ?>">
                                    <select name="sd_data[saswp-rbcc-ar-f-unit]" id="saswp-rbcc-ar-f-unit">
                                        <?php 
                                        $unit_array = array('px', 'pt', '%', 'em');
                                        foreach ($unit_array as $ukey => $uvalue) {
                                            $selected_value = isset($sd_data['saswp-rbcc-ar-f-unit'])?$sd_data['saswp-rbcc-ar-f-unit']:'';
                                            if($uvalue == $selected_value){
                                            ?>
                                                <option value="<?php echo esc_attr($uvalue);?>" selected><?php echo esc_html($uvalue);?></option>    
                                            <?php    
