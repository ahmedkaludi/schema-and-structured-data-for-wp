...
Class saswp_rating_box_frontend{
        ...
        public function saswp_display_review_box_schema(){
                        ...
                        if(saswp_global_option() && isset($sd_data['saswp-review-module']) && $sd_data['saswp-review-module'] == 1){
                            ...
                            $saswp_review_details           = saswp_get_post_meta(get_the_ID(), 'saswp_review_details', true);    
                        ...
                        if($overall_rating){
                            ...
                            $input1 = array(
                                    ...
                                    $input1['reviewRating'] = array(
                                        ...
                                        'description' => strip_tags(saswp_get_post_meta( get_the_ID(), 'saswp-review-item-description', true )),
                                     ); 
        ...
        public function saswp_get_review_box_content(){
            ...
            $saswp_review_details           = saswp_get_post_meta(get_the_ID(), 'saswp_review_details', true);             
            $saswp_review_description       = saswp_get_post_meta( get_the_ID(), 'saswp-review-item-description', true );
            $saswp_review_props             = saswp_get_post_meta( get_the_ID(), 'saswp-review-item-props', true );
            $saswp_review_cons              = saswp_get_post_meta( get_the_ID(), 'saswp-review-item-cons', true );
