...
class SASWP_Reviews_Form {
        ...
        public function saswp_reviews_form_render($attr){
            ...
            if(!$is_amp){ 
                ...
                if($on_button){
                    $form       .= '<div class="saswp-rv-form-btn"><a href="#" class="button button-default">'.esc_html__(saswp_label_text('translation-review-form')).'</a></div>';
                }
                ...
                if($on_button){
                    $form       .= '<div class="saswp-rv-form-btn"><a href="#" class="button button-default" on="tap:AMP.setState({ saswp_review_form_toggle: !saswp_review_form_toggle })" role="button" tabindex="1">'.esc_html__(saswp_label_text('translation-review-form')).'</a></div>';
                }
            ...
            $form   .= wp_nonce_field( 'saswp_review_form', 'saswp_review_nonce' )
                    ...
                    .   '<span>'.esc_html__(saswp_label_text('translation-name')).'</span>'
                    .   '<input type="text" name="saswp_reviewer_name" required>'
                    . '</div>'

                    . '<div class="saswp-form-fld">'
                    .   '<span>'.esc_html__(saswp_label_text('translation-comment')).'</span>'
