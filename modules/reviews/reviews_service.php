                    ...
                    foreach ($collection as $platform_wise){
                        ...
                        foreach ($platform_wise as $key => $value){
                            ...
                            if($platform_name == 'Self'){
                                $platform_name = esc_html__(saswp_label_text('translation-self'));
                            }
                      ...
                      $html .= esc_html__(saswp_label_text('translation-based-on')).' '.esc_attr($review_count).' '.esc_html__(saswp_label_text('translation-reviews'));
                      $html .= '</span>';
                      $html .= '</div>';
                      $html .= '</a>';
                      $html .= '</li>';                                                                     
    ...
    public function saswp_create_collection_popup($collection, $date_format,$saswp_collection_hide_col_rew_img='',$stars_color=''){
                ...
                if($collection){
                    ...
                    if($review_count > 0){
                        ...
                        $html .= saswp_get_rating_html_by_value($average_rating,$stars_color,$review_id);
                        $html .= '</span>';
                        $html .= '<span class="saswp-r4-rnm">'. esc_html(number_format ($average_rating, 1)).' '.esc_html__('from', 'schema-and-structured-data-for-wp').esc_html($review_count).' '.esc_html__('reviews', 'schema-and-structured-data-for-wp').'</span>';                    
                        $html .= '</li>';                                        
                        $html .= $html_list;
                        $html .= '</ul>';                    
                        $html .= '</div>';
