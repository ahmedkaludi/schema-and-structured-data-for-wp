     ...
     saswp_enable_rating_review();                       
        ...
        //star rating stars here
                ...
                e.preventDefault();
                    var html = '';
                        html    += '<tr>'
                                ...
                                + '<td style="width:10%;"><input class="saswp-g-blocks-field" name="sd_data[saswp_reviews_location_blocks][]" type="number" min="10" step="10" placeholder="10"></td>'                                                            
            ...
            $(document).on("click", '.saswp-fetch-g-reviews', function(){          
              ...
              var reviews_api        = $("#google_addon_license_key").val();
              var reviews_api_status = $("#google_addon_license_key_status").val();
              
              if(reviews_api && reviews_api_status == 'active'){
                  
                    if($("#saswp-google-rv-free-checkbox").length && $("#saswp-google-rv-free-checkbox").is(':checked')){
                        premium_status = 'free';
                    }else{
