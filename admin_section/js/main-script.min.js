     ...
     saswp_enable_rating_review();                       
        ...
        //star rating stars here
                ...
                e.preventDefault();
                    var html = '';
                        html    += '<tr>'
                                ...
                                + '<td><strong>Blocks </strong><input class="saswp-g-blocks-field" name="sd_data[saswp_reviews_location_blocks][]" type="number" placeholder="1 blocks = 10 reviews"></td>'                                    
            ...
            $(document).on("click", '.saswp-fetch-g-reviews', function(){          
              ...
              if($("#saswp_review_toggle_btn").is(':checked')){
