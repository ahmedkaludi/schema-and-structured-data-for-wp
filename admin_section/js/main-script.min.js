...
jQuery(document).ready(function (s) {
    if (
        (s(document).on("click", "#saswp_loc_display_on_front", function () {
                ...
                (function (a) {
                    a &&
                        s.ajax({
                            url: ajaxurl,
                            method: "GET",
                            data: { action: "saswp_get_select2_data", type: a, q: "", saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                            beforeSend: function () {},
                            success: function (a) {
                                if (a) {
                                    var e = "";
                                    s.each(a, function (s, a) {
                                        ...
                                        s(".saswp-collection-where-data").html(""),
                                        s(".saswp-collection-where-data").append(e),
                                        saswp_select2();
                                }
                            },
                            error: function (s) {
        ...
        s(".saswp-collection-display-method")
            .change(function () {
                "shortcode" == s(this).val()
                    ? (s(".saswp-coll-where").addClass("saswp_hide"), s("#saswp-motivatebox").css("display", "block"))
                    : (s(".saswp-coll-where").removeClass("saswp_hide"), s("#saswp-motivatebox").css("display", "none"));
            })
            .change(),
        s(document).on("click", ".saswp-dismiss-notices", function () {
            var a = s(this),
            ...
            e &&
                s.ajax({
                    ...
                    url: ajaxurl,
                    dataType: "json",
                    data: { action: "saswp_dismiss_notices", notice_type: e, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                    success: function (s) {
        ...
        saswp_select2(),
        s(".saswp-upgrade-to-pro").parent().attr({ href: "https://structured-data-for-wp.com/pricing/", target: "_blank" }),
        s(document).on("click", ".saswp-attach-reviews", function () {
            s(".saswp-enable-append-reviews").is(":checked")
                ? (tb_show(saswp_localize_data.translable_txt.attach_review, "#TB_inline??width=615&height=400&inlineId=saswp-embed-code-div"),
                  s(document).find("#TB_window").width(600).height(415).css({ top: "200px", "margin-top": "0px" }),
                  s(".saswp-attached-rv-count").show())
                : s(".saswp-attached-rv-count").hide();
        }),
        s(".close-attached-reviews-popup").on("click", function () {
            s("#TB_closeWindowButton").trigger("click");
        }),
        s("#saswp_attahced_reviews").val() && (saswp_attached_rv = JSON.parse(s("#saswp_attahced_reviews").val())),
        s("#saswp_attached_collection").val() && (saswp_attached_col = JSON.parse(s("#saswp_attached_collection").val())),
        s(document).on("click", ".saswp-attach-rv-checkbox", function () {
            var a;
            a = parseInt(s(this).parent().attr("data-id"));
            var e = s(this).parent().attr("data-type");
            s(this).is(":checked")
                ? ("review" == e && saswp_attached_rv.push(a), "collection" == e && saswp_attached_col.push(a))
                : ("review" == e && saswp_attached_rv.splice(saswp_attached_rv.indexOf(a), 1), "collection" == e && saswp_attached_col.splice(saswp_attached_col.indexOf(a), 1));
            ...
            t > 0 && (c += t + " Reviews, "),
                i > 0 && (c += i + " Collection"),
                c || (c = 0),
                s(".saswp-attached-rv-count").text("Attached " + c),
                s("#saswp_attahced_reviews").val(JSON.stringify(saswp_attached_rv)),
                s("#saswp_attached_collection").val(JSON.stringify(saswp_attached_col));
        }),
        s(".saswp-load-more-rv").on("click", function (a) {
            var e = s(this).attr("data-type"),
                t = s(".saswp-add-rv-loop[data-type=" + e + "]").length,
                i = t / 10 + 1;
            s("#saswp-add-rv-automatic .spinner").addClass("is-active"),
                a.preventDefault(),
                s.get(
                    ajaxurl,
                    { action: "saswp_get_reviews_on_load", data_type: e, offset: t, paged: i, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                    function (a) {
                        if ("t" == a.status) {
                            var t = "";
                            a.result &&
                                (s.each(a.result, function (s, a) {
                                    var i = "";
                                    "review" == e && saswp_attached_rv.includes(parseInt(a.saswp_review_id)) && (i = "checked"),
                                        "collection" == e && saswp_attached_col.includes(parseInt(a.saswp_review_id)) && (i = "checked"),
                                        (t += '<div class="saswp-add-rv-loop" data-type="' + e + '" data-id="' + a.saswp_review_id + '">'),
                                        "review" == e &&
                                            (t +=
                                                '<input class="saswp-attach-rv-checkbox" type="checkbox" ' +
                                                i +
                                                ">  <strong> " +
                                                a.saswp_reviewer_name +
                                                " ( Rating - " +
                                                a.saswp_review_rating +
                                                ' ) <span class="saswp-g-plus"><img src="' +
                                                a.saswp_review_platform_icon +
                                                '"/></span></strong>'),
                                        "collection" == e && (t += '<input class="saswp-attach-rv-checkbox" type="checkbox" ' + i + ">  <strong> " + a.saswp_reviewer_name + " </strong>"),
                                        (t += "</div>");
                                }),
                                s(".saswp-add-rv-automatic-list[data-type=" + e + "]").append(t)),
                                a.message && (s(".saswp-rv-not-found[data-type=" + e + "]").removeClass("saswp_hide"), s(".saswp-load-more-rv[data-type=" + e + "]").addClass("saswp_hide"));
        ...
        s(".saswp-enable-itemlist").change(function () {
            s(this).is(":checked")
                ? (s("#saswp_item_list_tags").show(), s(".saspw-item-list-note").show(), "custom" == s("#saswp_item_list_tags").val() ? s("#saswp_item_list_custom").show() : s("#saswp_item_list_custom").hide())
                : (s(".saspw-item-list-note").hide(), s("#saswp_item_list_tags").hide(), s("#saswp_item_list_custom").hide());
        }),
        ...
        s(document).on("click", ".saswp-add-g-location-btn", function (a) {
            var e;
            (e = s("#saswp_google_place_api_key").length
                ? '<input class="saswp-g-blocks-field" name="sd_data[saswp_reviews_location_blocks][]" type="number" min="5" step="5" placeholder="5" disabled="disabled">'
                : '<input class="saswp-g-blocks-field" name="sd_data[saswp_reviews_location_blocks][]" type="number" min="10" step="10" placeholder="10">'),
                a.preventDefault();
            var t = "";
            (t +=
                '<tr><td style="width:12%;"><strong>' +
                saswp_localize_data.translable_txt.place_id +
                '</strong></td><td style="width:20%;"><input class="saswp-g-location-field" name="sd_data[saswp_reviews_location_name][]" type="text" value=""></td><td style="width:10%;"><strong>' +
                saswp_localize_data.translable_txt.reviews +
                '</strong></td><td style="width:10%;">' +
                e +
                '</td><td style="width:10%;"><a class="button button-default saswp-fetch-g-reviews">' +
                saswp_localize_data.translable_txt.fetch +
                '</a></td><td style="width:10%;"><a type="button" class="saswp-remove-review-item button">x</a></td><td style="width:10%;"><p class="saswp-rv-fetched-msg"></p></td></tr>') && s(".saswp-g-reviews-settings-table").append(t);
        }),
        s(document).on("click", ".saswp-fetch-g-reviews", function () {
            ...
            if ("premium" == (a = s("#saswp_google_place_api_key").length ? "free" : "premium")) {
                ...
                if (0 != i % 10)
                    return e.parent().parent().find(".saswp-rv-fetched-msg").text(saswp_localize_data.translable_txt.step_in), e.parent().parent().find(".saswp-rv-fetched-msg").css("color", "#988f1b"), e.removeClass("updating-message"), !1;
            }
            "" != t && (p || c)
                ? s.ajax({
                      type: "POST",
                      url: ajaxurl,
                      dataType: "json",
                      data: { action: "saswp_fetch_google_reviews", reviews_api_status: o, reviews_api: p, location: t, blocks: i, g_api: c, premium_status: a, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                      success: function (s) {
                          "t" == s.status
                              ? (e.parent().parent().find(".saswp-rv-fetched-msg").text(saswp_localize_data.translable_txt.success), e.parent().parent().find(".saswp-rv-fetched-msg").css("color", "green"))
                              : (e.parent().parent().find(".saswp-rv-fetched-msg").text(s.message), e.parent().parent().find(".saswp-rv-fetched-msg").css("color", "#988f1b")),
                              e.removeClass("updating-message");
                      },
                      error: function (s) {
                          console.log(s);
                      },
                  })
                : ("" == t && alert(saswp_localize_data.translable_txt.enter_place_id),
                  "" == c && alert(saswp_localize_data.translable_txt.enter_api_key),
                  "" == p && alert(saswp_localize_data.translable_txt.enter_rv_api_key),
                  e.removeClass("updating-message"));
        }),
        saswp_localize_data.do_tour)
    ) {
        var a,
            e = "<h3>" + saswp_localize_data.translable_txt.using_schema + "</h3>";
        (e += "<p>" + saswp_localize_data.translable_txt.do_you_want + " <b>" + saswp_localize_data.translable_txt.sd_update + "</b> " + saswp_localize_data.translable_txt.before_others + "</p>"),
            (e += '<style type="text/css">'),
            (e += ".wp-pointer-buttons{ padding:0; overflow: hidden; }"),
            (e +=
                ".wp-pointer-content .button-secondary{  left: -25px;background: transparent;top: 5px; border: 0;position: relative; padding: 0; box-shadow: none;margin: 0;color: #0085ba;} .wp-pointer-content .button-primary{ display:none}  #saswp_mc_embed_signup{background:#fff; clear:left; font:14px Helvetica,Arial,sans-serif; }"),
            (e += "</style>"),
            (e += '<div id="saswp_mc_embed_signup">'),
            (e += '<form method="POST" accept-charset="utf-8" id="saswp-news-letter-form">'),
            (e += '<div id="saswp_mc_embed_signup_scroll">'),
            (e += '<div class="saswp-mc-field-group" style="    margin-left: 15px;    width: 195px;    float: left;">'),
            (e += '<input type="text" name="saswp_subscriber_name" class="form-control" placeholder="Name" hidden value="' + saswp_localize_data.current_user_name + '" style="display:none">'),
            (e += '<input type="text" value="' + saswp_localize_data.current_user_email + '" name="saswp_subscriber_email" class="form-control" placeholder="Email*"  style="      width: 180px;    padding: 6px 5px;">'),
            (e += '<input type="text" name="saswp_subscriber_website" class="form-control" placeholder="Website" hidden style=" display:none; width: 168px; padding: 6px 5px;" value="' + saswp_localize_data.get_home_url + '">'),
            (e += '<input type="hidden" name="ml-submit" value="1" />'),
            (e += "</div>"),
            (e += '<div id="mce-responses">'),
            (e += "</div>"),
            (e += '<div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_a631df13442f19caede5a5baf_c9a71edce6" tabindex="-1" value=""></div>'),
            (e +=
                '<input type="submit" value="Subscribe" name="subscribe" id="pointer-close" class="button mc-newsletter-sent" style=" background: #0085ba; border-color: #006799; padding: 0px 16px; text-shadow: 0 -1px 1px #006799,1px 0 1px #006799,0 1px 1px #006799,-1px 0 1px #006799; height: 30px; margin-top: 1px; color: #fff; box-shadow: 0 1px 0 #006799;">'),
            (e += '<p id="saswp-news-letter-status"></p>'),
            (e += "</div>"),
            (e += "</form>"),
            (e += "</div>"),
            s(document).on("submit", "#saswp-news-letter-form", function (a) {
                a.preventDefault();
                var e = s(this),
                    t = e.find('input[name="saswp_subscriber_name"]').val(),
                    i = e.find('input[name="saswp_subscriber_email"]').val();
                (website = e.find('input[name="saswp_subscriber_website"]').val()),
                    s.post(saswp_localize_data.ajax_url, { action: "saswp_subscribe_to_news_letter", saswp_security_nonce: saswp_localize_data.saswp_security_nonce, name: t, email: i, website: website }, function (a) {
                        a
                            ? "Some fields are missing." == a
                                ? (s("#saswp-news-letter-status").text(""), s("#saswp-news-letter-status").css("color", "red"))
                                ...
                                ? (s("#saswp-news-letter-status").text(""), s("#saswp-news-letter-status").css("color", "red"))
                                : (s("#saswp-news-letter-status").text("You're subscribed!"), s("#saswp-news-letter-status").css("color", "green"))
                            : alert("Sorry, unable to subscribe. Please try again later!");
                    });
            });
        var t = { content: e, position: { edge: "top", align: "left" } };
        (a = function () {
            s(saswp_localize_data.displayID).pointer(t).pointer("open"),
                saswp_localize_data.button2 &&
                    ...
                    jQuery("#pointer-close").click(function () {
                        s.post(saswp_localize_data.ajax_url, { pointer: "saswp_subscribe_pointer", action: "dismiss-wp-pointer" });
                    }));
        }),
            (t = s.extend(t, {
                ...
                show: function (s, a) {
                    a.pointer.css({ left: "170px", top: "160px" });
                },
            })).position && t.position.defer_loading
                ? s(window).bind("load.wp-pointers", a)
                : a();
    }
    var i;
    if (
        (s(".saswp-tabs a").click(function (a) {
            var e = s(this).attr("href"),
                t = getParameterByName("tab", e);
            return (
                t || (t = "general"),
                s(this).siblings().removeClass("nav-tab-active"),
                s(this).addClass("nav-tab-active"),
                "premium_features" == t && "yes" == jQuery(this).attr("data-extmgr")
                    ? (window.location.href = "edit.php?post_type=saswp&page=saswp-extension-manager")
                    : (s(".form-wrap")
                          .find(".saswp-" + t)
                          .siblings()
                          .hide(),
                      s(".form-wrap .saswp-" + t).show(),
                      window.history.pushState("", "", e)),
                !1
            );
        }),
        s(".saswp-schame-type-select").select2(),
        s(".saswp-schame-type-select").change(function (a) {
            a.preventDefault(), s(".saswp-custom-fields-table").html("");
            var e = s(this).val();
            s(".saswp-option-table-class tr").each(function (a, e) {
                a > 0 && s(this).hide();
            }),
                "TechArticle" == e || "Article" == e || "Blogposting" == e || "NewsArticle" == e || "WebPage" == e ? s(".saswp-enable-speakable").parent().parent().show() : s(".saswp-enable-speakable").parent().parent().hide(),
                "Book" == e ||
                "Course" == e ||
                "Organization" == e ||
                "CreativeWorkSeries" == e ||
                "MobileApplication" == e ||
                "ImageObject" == e ||
                "HowTo" == e ||
                "MusicPlaylist" == e ||
                ...
                "Product" == e ||
                "Review" == e
                    ? s(".saswp-enable-append-reviews").parent().parent().show()
                    : s(".saswp-enable-append-reviews").parent().parent().hide(),
                "VideoObject" == e ? s(".saswp-enable-markup-class").parent().parent().show() : s(".saswp-enable-markup-class").parent().parent().hide(),
                s("#saswp_location_meta_box").addClass("saswp_hide"),
                "local_business" == e &&
                    (s("#saswp_location_meta_box").removeClass("saswp_hide"),
                    s(".saswp-option-table-class tr").eq(1).show(),
                    s(".saswp-business-text-field-tr").show(),
                    s(".saswp-option-table-class tr").find("select").attr("disabled", !1),
                    s(".select-post-type").val("show_globally").trigger("change")),
                "Service" == e && (s(".saswp-service-text-field-tr").show(), s(".saswp-option-table-class tr").find("select").attr("disabled", !1)),
                "Event" == e && (s(".saswp-event-text-field-tr").show(), s(".saswp-option-table-class tr").find("select").attr("disabled", !1)),
                "Review" == e && (s(".saswp-review-text-field-tr").show(), s(".saswp-option-table-class tr").find("select").attr("disabled", !1), s(".saswp-item-reivewed-list").change()),
                "ItemList" == e
                    ? (s(".saswp-schema-modify-section").hide(), s(".saswp-itemlist-text-field-tr").show(), s(".saswp-option-table-class tr").find("select").attr("disabled", !1), s(".saswp-itemlist-item-type-list").change())
                    : s(".saswp-schema-modify-section").show(),
                saswp_enable_rating_review(),
                s(".saswp-manual-modification").html(""),
                s(".saswp-static-container .spinner").addClass("is-active"),
                s.get(ajaxurl, { action: "saswp_get_manual_fields_on_ajax", schema_type: e, post_id: saswp_localize_data.post_id, saswp_security_nonce: saswp_localize_data.saswp_security_nonce }, function (a) {
                ...
                "HowTo" == e || "local_business" == e || "FAQ" == e
                    ? s(".saswp-enable-modify-schema").show()
                    : (s(".saswp-enable-modify-schema-output").val("automatic"), s(".saswp-enable-modify-schema-output").change(), s(".saswp-enable-modify-schema").hide());
        }),
        s("#saswp_business_type").select2(),
        s(".saswp-local-sub-type-2").select2(),
        s("#saswp_business_type")
            .change(function () {
                var a = s(this).val(),
                ...
                s(".saswp-option-table-class tr").each(function (a, e) {
                    ...
                    "local_business" == e &&
                        ...
                        s(".saswp-" + a + "-tr")
                            ...
                            .attr("disabled", !1),
                        s("#saswp_location_meta_box").removeClass("saswp_hide")),
                    "Review" == e && (s(".saswp-review-text-field-tr").show(), s(".saswp-review-text-field-tr").find("select").attr("disabled", !1)),
                    "ItemList" == e ? (s(".saswp-schema-modify-section").hide(), s(".saswp-itemlist-text-field-tr").show(), s(".saswp-option-table-class tr").find("select").attr("disabled", !1)) : s(".saswp-schema-modify-section").show(),
                    "Event" == e && (s(".saswp-event-text-field-tr").show(), s(".saswp-option-table-class tr").find("select").attr("disabled", !1)),
                    saswp_enable_rating_review();
            })
            .change(),
            ...
            .change(function () {
                ...
                switch (a) {
                    ...
                    case "saswp_kb_contact_1_checkbox":
                        s(this).is(":checked")
                            ? (s("#saswp_kb_contact_1").val(1), s("#saswp_kb_telephone, #saswp_contact_type").parent().parent("li").removeClass("saswp-display-none"))
                            : (s("#saswp_kb_contact_1").val(0), s("#saswp_kb_telephone, #saswp_contact_type").parent().parent("li").addClass("saswp-display-none"));
                        break;
                    case "saswp-logo-dimensions-check":
                        s(this).is(":checked")
                            ? (s("#saswp-logo-dimensions").val(1), s("#saswp-logo-width, #saswp-logo-height").parent().parent("li").show())
                            : (s("#saswp-logo-dimensions").val(0), s("#saswp-logo-width, #saswp-logo-height").parent().parent("li").hide());
                        break;
                    case "saswp_archive_schema_checkbox":
                        s(this).is(":checked")
                            ? (s("#saswp_archive_schema").val(1), s(".saswp_archive_schema_type_class").parent().parent().show())
                            : (s("#saswp_archive_schema").val(0), s(".saswp_archive_schema_type_class").parent().parent().hide());
                        break;
                    ...
                    case "saswp_breadcrumb_schema_checkbox":
                        s(this).is(":checked")
                            ? (s("#saswp_breadcrumb_schema").val(1), s("#saswp_breadcrumb_remove_cat").parent().parent().show())
                            : (s("#saswp_breadcrumb_schema").val(0), s("#saswp_breadcrumb_remove_cat").parent().parent().hide());
                        break;
                    ...
                    case "saswp-stars-rating-checkbox":
                        s(this).is(":checked")
                            ? (s(".saswp-stars-post-table").removeClass("saswp_hide"), s(this).parent().parent().next().removeClass("saswp_hide"), s("#saswp-stars-rating").val(1))
                            : (s(this).parent().parent().next().addClass("saswp_hide"), s(".saswp-stars-post-table").addClass("saswp_hide"), s("#saswp-stars-rating").val(0));
                        break;
                    ...
                    case "saswp-woocommerce-booking-checkbox":
                        saswp_compatibliy_notes(e, a),
                            s(this).is(":checked") ? (s("#saswp-woocommerce-booking").val(1), s("#saswp-woocommerce-booking-main").val(1)) : (s("#saswp-woocommerce-booking").val(0), s("#saswp-woocommerce-booking-main").val(0));
                        break;
                    case "saswp-woocommerce-booking-main-checkbox":
                        saswp_compatibliy_notes(e, a),
                            s(this).is(":checked") ? (s("#saswp-woocommerce-booking-main").val(1), s("#saswp-woocommerce-booking").val(1)) : (s("#saswp-woocommerce-booking-main").val(0), s("#saswp-woocommerce-booking").val(0));
                        break;
                    ...
                    case "saswp-shopper-approved-review-checkbox":
                        saswp_compatibliy_notes(e, a),
                            s(this).is(":checked")
                                ? (s("#saswp-shopper-approved-review").val(1), s(".saswp-s-reviews-settings-table").parent().parent().parent().show())
                                : (s("#saswp-shopper-approved-review").val(0), s(".saswp-s-reviews-settings-table").parent().parent().parent().hide());
                        break;
                    case "saswp-google-review-checkbox":
                        s(this).is(":checked")
                            ? (s("#saswp-google-review").val(1),
                              s("#saswp-google-rv-free-checkbox").length
                                  ? (s("#saswp-google-review-free").parent().parent().show(),
                                    s("#saswp-google-rv-free-checkbox").is(":checked") ? s("#saswp_google_place_api_key").parent().parent().show() : s("#saswp_google_place_api_key").parent().parent().hide())
                                  : s("#saswp_google_place_api_key").parent().parent().show(),
                              s(".saswp-g-reviews-settings-table").parent().parent().parent().show())
                            : (s("#saswp-google-review").val(0),
                              s("#saswp_google_place_api_key").parent().parent().hide(),
                              s(".saswp-g-reviews-settings-table").parent().parent().parent().hide(),
                              s("#saswp-google-rv-free-checkbox").length && s("#saswp-google-review-free").parent().parent().hide());
                        break;
                    case "saswp-google-rv-free-checkbox":
                        s("#saswp-google-review-checkbox").is(":checked") && s(this).is(":checked")
                            ? (s("#saswp-google-review-free").val(1), s("#saswp_google_place_api_key").parent().parent().show())
                            : (s("#saswp-google-review-free").val(0), s("#saswp_google_place_api_key").parent().parent().hide());
                        break;
                    ...
                    case "saswp-resized-image-folder-checkbox":
                        ...
                        s(this).is(":checked")
                            ? s.ajax({
                                  ...
                                  success: function (a) {
                                      "t" == a.status
                                          ? (s("#saswp-resized-image-folder").val(1), s("#saswp-resized-image-folder-checkbox").after('<a class="saswp-clear-images button button-default">Clear Images</a>'))
                                          : (t.prop("checked", !1), t.next().text(a.message), t.next().css("color", "red"));
                                  },
                                  error: function (s) {
        ...
        s("#saswp_kb_type")
            .change(function () {
                var a = s(this).val();
                s(".saswp_org_fields, .saswp_person_fields").parent().parent().addClass("saswp_hide"),
                    s(".saswp_kg_logo").parent().parent().parent().addClass("saswp_hide"),
                    s("#sd-person-image").parent().parent().parent().addClass("saswp_hide"),
                    "Organization" == a &&
                        (s(".saswp_org_fields").parent().parent().removeClass("saswp_hide"),
                        s(".saswp_person_fields").parent().parent().addClass("saswp_hide"),
                        s(".saswp_kg_logo").parent().parent().parent().removeClass("saswp_hide"),
                        s("#sd-person-image").parent().parent().parent().addClass("saswp_hide")),
                    "Person" == a &&
                        (s(".saswp_org_fields").parent().parent().addClass("saswp_hide"),
                        s(".saswp_person_fields").parent().parent().removeClass("saswp_hide"),
                        s(".saswp_kg_logo").parent().parent().parent().removeClass("saswp_hide"),
                        s("#sd-person-image").parent().parent().parent().removeClass("saswp_hide"));
            })
            .change(),
        s(document).on("click", "input[data-id=media]", function (a) {
            a.preventDefault();
            var e = s(this),
                t = e.attr("id").replace("_button", ""),
                i = wp
                    .media({ title: "Application Icon", button: { text: "Select Icon" }, multiple: !1, library: { type: "image" } })
                    .on("select", function () {
                        var a = i.state().get("selection").first().toJSON();
                        s("#" + t).val(a.url),
                            s("input[data-id='" + t + "_id']").val(a.id),
                            s("input[data-id='" + t + "_height']").val(a.height),
                            s("input[data-id='" + t + "_width']").val(a.width),
                            s("input[data-id='" + t + "_thumbnail']").val(a.url),
                            "sd_default_image_button" === e.attr("id") && (s("#sd_default_image_width").val(a.width), s("#sd_default_image_height").val(a.height));
                        var c = "";
                        "saswp_image_div_" + t == "saswp_image_div_sd_default_image" && a.height < 1200 && (c = '<p class="saswp_warning">Image size is smaller than recommended size</p>'),
                            s(".saswp_image_div_" + t).html('<div class="saswp_image_thumbnail"><img class="saswp_image_prev" src="' + a.url + '"/><a data-id="' + t + '" href="#" class="saswp_prev_close">X</a></div>' + c);
                    })
                    .open();
        }),
        s(document).on("click", ".saswp_prev_close", function (a) {
            ...
            s(this).parent().remove(),
                s("#" + e).val(""),
                s("input[data-id='" + e + "_id']").val(""),
                s("input[data-id='" + e + "_height']").val(""),
                s("input[data-id='" + e + "_width']").val(""),
                s("input[data-id='" + e + "_thumbnail']").val(""),
                "sd_default_image" === e && (s("#sd_default_image_width").val(""), s("#sd_default_image_height").val(""));
        }),
        s(document).on("click", ".saswp-modify-schema", function (a) {
            ...
            t.addClass("updating-message"),
                s.get(ajaxurl, { action: "saswp_modify_schema_post_enable", tag_ID: saswp_localize_data.tag_ID, schema_id: e, post_id: saswp_localize_data.post_id, saswp_security_nonce: saswp_localize_data.saswp_security_nonce }, function (
                    a
                ) {
                    s(".saswp-post-specific-wrapper[data-id=" + e + "] .saswp-post-specific-setting").after(a),
                        s(".saswp_modify_this_schema_hidden_" + e).val(1),
                        s(".saswp-ps-toggle[schema-id=" + e + "]").removeClass("saswp_hide"),
                        s(".saswp-restore-schema[schema-id=" + e + "]")
                            .parent()
                            .removeClass("saswp_hide"),
                        s(".saswp-modify-schema[schema-id=" + e + "]")
                            .parent()
                            .addClass("saswp_hide"),
                        t.removeClass("updating-message"),
        ...
        s(document).on("click", ".saswp-restore-schema", function (a) {
            ...
            t.addClass("updating-message"),
                s.post(
                    ajaxurl,
                    { action: "saswp_modify_schema_post_restore", tag_ID: saswp_localize_data.tag_ID, schema_id: e, post_id: saswp_localize_data.post_id, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                    function (a) {
                        t.removeClass("updating-message"),
                            "t" == a.status
                                ? (s(".saswp_modify_this_schema_hidden_" + e).val(0),
                                  s(".saswp-restore-schema[schema-id=" + e + "]")
                                      .parent()
                                      .addClass("saswp_hide"),
                                  s(".saswp-modify-schema[schema-id=" + e + "]")
                                      .parent()
                                      .removeClass("saswp_hide"),
                                  s(".saswp-ps-toggle[schema-id=" + e + "]").remove())
        ...
        s(document).on("change", ".saswp-schema-type-toggle", function (a) {
            ...
            if (s(this).is(":checked")) {
                var c = 0;
                s(".saswp-ps-toggle[schema-id=" + e + "]").addClass("saswp_hide"),
                    s(".saswp-restore-schema[schema-id=" + e + "]")
                        .parent()
                        .addClass("saswp_hide"),
                    s(".saswp-modify-schema[schema-id=" + e + "]")
                        .parent()
                        .addClass("saswp_hide"),
                    s("#saswp_custom_schema_field[schema-id=" + e + "]")
                        .parent()
                        .addClass("saswp_hide");
            } else
                s("#saswp_custom_schema_field[schema-id=" + e + "]")
            ...
            s.ajax({
                ...
                url: ajaxurl,
                dataType: "json",
                data: { action: "saswp_enable_disable_schema_on_post", status: c, schema_id: e, post_id: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                success: function (s) {},
                error: function (s) {
                    console.log(s);
                },
        ...
        s(document).on("click", ".saswp_license_activation", function (a) {
            ...
            t && i && c
                ? s.ajax({
                      ...
                      url: ajaxurl,
                      dataType: "json",
                      data: { action: "saswp_license_status_check", license_key: c, license_status: t, add_on: i, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                      success: function (a) {
                          s("#" + i + "_addon_license_key_status").val(a.status),
                              "active" == a.status
                                  ? (s(".saswp-" + i + "-dashicons").addClass("dashicons-yes"),
                                    s(".saswp-" + i + "-dashicons").removeClass("dashicons-no-alt"),
                                    s(".saswp-" + i + "-dashicons").css("color", "green"),
                                    s(".saswp_license_activation[add-on='" + i + "']").attr("license-status", "inactive"),
                                    jQuery("span.inactive_status_" + i + "").text('Active'),
                               jQuery("span.inactive_status_" + i + "").css("color", "green"),
                               jQuery("span.inactive_status_" + i + "").removeClass("inactive_status_" + i + "").addClass("addon-activated_" + i + ""),
                                    s(".saswp_license_activation[add-on='" + i + "']").text("Deactivate"),
                                    jQuery("span.addon-activated_reviews").css({ color: "green", "margin-left": "8px", "font-weight": "400" }),
                               
                                    s(".saswp_license_status_msg[add-on='" + i + "']").text("Activated"),
                                    s(".saswp_license_status_msg[add-on='" + i + "']").css("color", "green"),
                                    s(".saswp_license_status_msg[add-on='" + i + "']").text(a.message))
                                  : (s(".saswp-" + i + "-dashicons").addClass("dashicons-no-alt"),
                                    s(".saswp-" + i + "-dashicons").removeClass("dashicons-yes"),
                                    s(".saswp-" + i + "-dashicons").css("color", "red"),
                                    s(".saswp_license_activation[add-on='" + i + "']").attr("license-status", "active"),
                                    s(".saswp_license_activation[add-on='" + i + "']").text("Activate"),
                                    jQuery("span.addon-activated_" + i + "").text('Inactive'),
                               jQuery("span.addon-activated_" + i + "").css("color", "#bebfc0"),
                               s("span.limit_span").css("display", "none"),
        ...
        (i = document.getElementById("activated-plugins-days_remaining")))
    )
        var c = i.getAttribute("days_remaining");
    if (
        (c >= 0 &&
            c <= 7 &&
            setTimeout(function () {
        ...
        s(document).on("click", "#refresh_license_icon_top-", function (a) {
            ...
            s(this).attr("add-onname"),
                e &&
                    ...
                    (s.ajax({
                        ...
                        url: ajaxurl,
                        dataType: "json",
                        data: { action: "saswp_license_status_check", license_key: i, license_status: e, add_on: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                        success: function (a) {
                    ...
                    jQuery.ajax({
                        ...
                        url: ajaxurl,
                        dataType: "json",
                        data: { action: "saswp_license_transient", license_key: i, license_status: e, add_on: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                        success: function (s) {
                            JSON.parse(s);
                        },
                    }));
    ...
    e.preventDefault();
    var a = t.attr("add-on"),
        n = t.attr("remaining_days_org"),
        r = jQuery("#" + a + "_addon_license_key").val();
    document.getElementById("user_refresh_" + a).classList.add("spin");
    var o = new Date();
    var c = (function (e) {
            for (var t = e + "=", s = document.cookie.split(";"), a = 0; a < s.length; a++) {
                for (var n = s[a]; " " == n.charAt(0); ) n = n.substring(1, n.length);
                if (0 == n.indexOf(t)) return n.substring(t.length, n.length);
            }
            return null;
        })("saswp_addon_refresh_check"),
        e = -1;
    null != typeof (c = new Date(c)) && ((i = Math.abs(o.getTime() - c.getTime())), (e = Math.ceil(i / 864e5)));
    var n = new Date(n),
        i = Math.abs(n.getTime() - o.getTime()),
        i = Math.ceil(i / 864e5);
    -1 == e || 1 < e || i < 1
        ? ((document.cookie = "saswp_addon_refresh_check=" + o),
          jQuery.ajax({
              type: "POST",
              url: ajaxurl,
              dataType: "json",
              data: { action: "saswp_license_status_check", license_key: r, license_status: "active", add_on: a, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
              success: function (e) {
                  s("#" + a + "_addon_license_key_status").val(e.status), document.getElementById("user_refresh_" + a).classList.remove("spin"), t.removeClass("updating-message");
              },
              error: function (e) {
                  console.log(e);
              },
        ...
        : (setTimeout(function () {
              jQuery(".dashicons").removeClass("spin");
          }, 0),
          (c = Math.abs(c.getDate() + 1) + "/" + Math.abs(c.getMonth() + 1) + "/" + c.getFullYear() + " " + c.getHours() + ":" + c.getMinutes() + ":" + c.getSeconds()),
          alert("Please try after " + c));
}),
        ...
        c = i.getAttribute("days_remaining");
    if (
        (setTimeout(function () {
            s("#refresh_expired_addon-").trigger("click");
        }, 0),
        s(document).on("click", "#refresh_expired_addon-", function (a) {
            ...
            s(this).attr("add-onname"),
                e &&
                    ...
                    (s.ajax({
                        ...
                        data: { action: "saswp_license_status_check", license_key: i, license_status: e, add_on: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                        success: function (a) {
                            s("#" + t + "_addon_license_key_status").val(a.status),
                                document.getElementById("refresh_expired_addon").classList.remove("spin"),
                                "active" == a.status &&
                                    ((remaining_days = a.days_remaining),
                                    remaining_days < 0
                                        ? s("span#exp").text("Expired")
                                        : remaining_days > 7 &&
                                          (s("span.inner_span").text(""),
                                          s("span.saswp_addon_inactive").text(""),
                                          s("span.expiredinner_span").text("Your License is Active"),
                                          s("span.expiredinner_span").css("color", "green"),
                                          s(".renewal-license").css("display", "none"),
                                          s(".saswp_addon_icon").css("display", "none")));
                        },
                        error: function (s) {
                            console.log(s);
                        },
                    ...
                    jQuery.ajax({
                        ...
                        url: ajaxurl,
                        dataType: "json",
                        data: { action: "saswp_expired_license_transient", license_key: i, license_status: e, add_on: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                        success: function (s) {
                            JSON.parse(s);
                        },
                    }));
    ...
    s(document).on("click", "#user_refresh_expired_addon-", function (a) {
                ...
                success: function (a) {
                    s("#" + t + "_addon_license_key_status").val(a.status),
                        ...
                        "active" == a.status &&
                            ((remaining_days = a.days_remaining),
                            remaining_days < 0
                                ? (s("span#exp").text("Expired"), location.reload())
                                : remaining_days > 7 &&
                                  (s("span.inner_span").text(""),
                                  s("span.saswp_addon_inactive").text(""),
                                  s("span.expiredinner_span").text("Your License is Active"),
        ...
        s(".saswp-send-query").on("click", function (a) {
            ...
            "" != s.trim(e) && i && "" != s.trim(t) && 1 == saswpIsEmail(t)
                ? s.ajax({
                      type: "POST",
                      url: ajaxurl,
                      dataType: "json",
                      data: { action: "saswp_send_query_message", premium_cus: i, message: e, email: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                      success: function (a) {
                ...
                : ("" == i && alert("Select Customer type"), "" == s.trim(e) && alert("Please enter the message"), "" == s.trim(t) && alert("Please enter the email"), 0 == saswpIsEmail(t) && alert("Please enter a valid email"));
        }),
        s(".saswp-import-plugins").on("click", function (a) {
            ...
            s.get(
                ajaxurl,
                { action: "saswp_import_plugin_data", plugin_name: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                function (a) {
                    "t" == a.status
                        ? (s(e).parent().find(".saswp-imported-message").text(a.message),
                          s(e).parent().find(".saswp-imported-message").removeClass("saswp-error"),
                          setTimeout(function () {
                              location.reload();
                          }, 2e3))
                        : (s(e).parent().find(".saswp-imported-message").addClass("saswp-error"), s(e).parent().find(".saswp-imported-message").text(a.message)),
                        e.removeClass("updating-message");
                },
                "json"
            );
        ...
        s(document).on("change", ".saswp-local-business-type-select", function (a) {
            ...
            s.get(
                ajaxurl,
                { action: "saswp_get_sub_business_ajax", business_type: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                function (a) {
                    if ("t" == a.status) {
                        ...
                        (i += '<td><select class="saswp-local-business-name-select" id="saswp_business_name_' + t + '" name="saswp_business_name_' + t + '">'),
                            s.each(a.result, function (s, a) {
                                i += '<option value="' + s + '">' + a + "</option>";
                            }),
                            (i += "</select></td>"),
                            (i += "</tr>"),
                            e.parents(".form-table tr:first").after(i);
        ...
        s(document).on("click", ".saswp-add-more-item", function (a) {
            a.preventDefault(),
                s(".saswp-review-item-list-table").append(
                    '<tr class="saswp-review-item-tr"><td>Review Item Feature</td><td><input type="text" name="saswp-review-item-feature[]"></td><td>Rating</td><td><input step="0.1" min="0" max="5" type="number" name="saswp-review-item-star-rating[]"></td><td><a type="button" class="saswp-remove-review-item button">x</a></td></tr>'
                );
        }),
        ...
        s(document).on("click", ".saswp-restore-post-schema", function (a) {
            ...
            s.post(
                ajaxurl,
                { action: "saswp_restore_schema", schema_ids: t, post_id: saswp_localize_data.post_id, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                function (s) {
                    "t" == s.status
                        ? setTimeout(function () {
                              location.reload();
        ...
        s(document).on("click", "div.saswp-tab ul.saswp-tab-nav a", function (a) {
            a.preventDefault();
            var e = s(this).attr("data-id");
            s(".saswp-post-specific-wrapper").hide(),
                s("#" + e).show(),
                s("div.saswp-tab ul.saswp-tab-nav a").removeClass("selected"),
                s("div.saswp-tab ul.saswp-tab-nav li").removeClass("selected"),
                s(this).addClass("selected"),
                s(this).parent().addClass("selected"),
                saswp_enable_rating_review();
        }),
        s("#saswp-global-tabs a:first").addClass("saswp-global-selected"),
        s(".saswp-global-container").hide();
    var p = window.location.hash;
    if (
        ("#saswp-default-container" == p ? s(".saswp-global-container:eq(2)").show() : "#saswp-knowledge-container" == p ? s(".saswp-global-container:eq(1)").show() : s(".saswp-global-container:first").show(),
        s("#saswp-global-tabs a").click(function () {
        ...
        s("#saswp-review-tabs a:first").addClass("saswp-global-selected"),
        s(".saswp-review-container").hide(),
        s(".saswp-review-container:first").show(),
        s("#saswp-review-tabs a").click(function () {
            var a = s(this).attr("data-id");
        ...
        s("#saswp-compatibility-tabs a:first").addClass("saswp-global-selected"),
        s(".saswp-compatibility-container").hide(),
        s(".saswp-compatibility-container:first").show(),
        s("#saswp-compatibility-tabs a").click(function () {
            var a = s(this).attr("data-id");
        ...
        s('a[href="' + saswp_localize_data.new_url_selector + '"]').attr("href", saswp_localize_data.new_url_href),
        s(".saswp-enable-modify-schema-output").on("change", function () {
            s(".saswp-static-container").addClass("saswp_hide"),
                s(".saswp-dynamic-container").addClass("saswp_hide"),
                "manual" == s(this).val() && (s(".saswp-static-container").removeClass("saswp_hide"), s(".saswp-dynamic-container").addClass("saswp_hide")),
                "automatic" == s(this).val() && (s(".saswp-static-container").addClass("saswp_hide"), s(".saswp-dynamic-container").removeClass("saswp_hide"));
        }),
        s(document).on("change", ".saswp-custom-fields-name", function () {
            var a = "text",
                e = s(this).parent().parent("tr"),
                t = s(this).val();
            (-1 == t.indexOf("_image") && -1 == t.indexOf("_logo")) || (a = "image");
        ...
        s(document).on("click", ".saswp-skip-button", function (a) {
            a.preventDefault(), s(this).parent().parent().hide(), s.post(ajaxurl, { action: "saswp_skip_wizard", saswp_security_nonce: saswp_localize_data.saswp_security_nonce }, function (s) {}, "json");
        }),
        ...
        s(document).on("change", ".saswp-custom-meta-list", function () {
            ...
            "manual_text" == t
                ? ((c += '<td><input type="text" name="saswp_fixed_text[' + i + ']"></td>'),
                  (c += '<td><a class="button button-default saswp-rmv-modify_row">X</a></td>'),
                  s(this).parent().parent("tr").find("td:gt(1)").remove(),
                  s(this).parent().parent("tr").append(c),
                  saswpCustomSelect2())
                : "taxonomy_term" == t
                ? saswp_taxonomy_term.taxonomy
                    ? ((c += saswp_taxonomy_term_html(saswp_taxonomy_term.taxonomy, i)), a.parent().parent("tr").find("td:gt(1)").remove(), a.parent().parent("tr").append(c), saswpCustomSelect2())
                    : s.get(
                          ajaxurl,
                ...
                : "custom_field" == t
                ? ((c += '<td><select class="saswp-custom-fields-select2" name="saswp_custom_meta_field[' + i + ']">'),
                  (c += "</select></td>"),
                  (c += '<td><a class="button button-default saswp-rmv-modify_row">X</a></td>'),
                  s(this).parent().parent("tr").find("td:gt(1)").remove(),
                  s(this).parent().parent("tr").append(c),
                ...
                ? ((c += "<td>"),
                  (c += "<fieldset>"),
                  (c += '<input data-id="media" style="width: 30%;" class="button" id="' + p + '_button" name="' + p + '_button" type="button" value="Upload" />'),
                  (c += '<input type="hidden" data-id="' + p + '_height" class="upload-height" name="' + o + '[height]" id="' + p + '_height" value="">'),
                  (c += '<input type="hidden" data-id="' + p + '_width" class="upload-width" name="' + o + '[width]" id="' + p + '_width" value="">'),
                  (c += '<input type="hidden" data-id="' + p + '_thumbnail" class="upload-thumbnail" name="' + o + '[thumbnail]" id="' + p + '_thumbnail" value="">'),
                  (c += '<div class="saswp_image_div_' + p + '">'),
                  (c += "</div>"),
                  (c += "</fieldset>"),
                  (c += "</td>"),
                  (c += '<td><a class="button button-default saswp-rmv-modify_row">X</a></td>'),
                  ...
                  s(this).parent().parent("tr").append(c),
                  saswpCustomSelect2())
                : ((c += "<td></td>"), (c += '<td><a class="button button-default saswp-rmv-modify_row">X</a></td>'), s(this).parent().parent("tr").find("td:gt(1)").remove(), s(this).parent().parent("tr").append(c), saswpCustomSelect2());
        }),
        ...
        s(document).on("click", ".saswp-add-custom-fields", function () {
            ...
            var c = s("#post_ID").val();
            "" != e &&
                (saswp_meta_list_fields[e]
                    ? saswp_get_meta_list(a, "text", saswp_meta_list_fields[e], null, i, null)
                    : s.ajax({
                          type: "POST",
                          url: ajaxurl,
                          dataType: "json",
                          data: { action: "saswp_get_schema_type_fields", post_id: c, schema_type: e, schema_subtype: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                          success: function (s) {
        ...
        saswpCustomSelect2(),
        saswp_enable_rating_review(),
        s('a[href="' + saswp_localize_data.collection_post_add_url + '"]').attr("href", saswp_localize_data.collection_post_add_new_url),
        s(document).on("click", ".saswp_coonect_google_place", function () {
            ...
            "" != a &&
                s.ajax({
                    ...
                    url: ajaxurl,
                    dataType: "json",
                    data: { action: "saswp_connect_google_place", place_id: a, language: e, google_api: t, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                    success: function (s) {
        ...
        s(document).on("click", ".saswp-add-social-links", function () {
            s(".saswp-social-links-table").append(
                '<tr><td><input type="text" placeholder="https://www.facebook.com/profile" name="sd_data[saswp_social_links][]" value=""></td><td><a class="button button-default saswp-rmv-modify_row">X</a></td></tr>'
            );
        }),
        s(document).on("click", ".saswp-show-accept-rv-popup", function () {
            tb_show("Reviews Form", "#TB_inline??width=600&height=400&inlineId=saswp-accept-reviews-popup"), s(document).find("#TB_window").width(600).height(400).css({ top: "100px", "margin-top": "0px" });
        }),
        ...
        (o += '<div style="display:none;" id="saswp-accept-reviews-popup">'),
            (o += '<div class="saswp-accept-rv-container">'),
            (o += "<p>Use Below shortcode to show reviews form in your website. Using this you can accept reviews from your website directly</p>"),
            (o += '<div class="saswp-show-form-on-tab"><strong>Simple Form</strong> <input value="[saswp-reviews-form]" type="text" readonly></div>'),
            (o += '<div class="saswp-show-form-on-tab"><strong>Show form on button tap</strong> <input value="[saswp-reviews-form onbutton=&quot;1&quot;]" type="text" readonly></div>'),
            (o +=
                '<p><strong>Note:</strong> To enable google reCAPTCHA v2 add SITE KEY & SECRET KEY respectively as parameters in above shortcode. Eg <input value="[saswp-reviews-form site_key=&quot;your key&quot; secret_key=&quot;your key&quot;]" type="text" readonly>. To get keys <a target="_blank" href="https://www.google.com/recaptcha/admin/create">Click here.</a> You must choose reCAPTCHA type v2 </p>'),
            (o += "</div>"),
            (o += "</div>"),
            (o += '<h2 class="nav-tab-wrapper">'),
            (o += "<a href=" + saswp_localize_data.reviews_page_url + ' class="nav-tab ' + (saswp_localize_data.current_url == saswp_localize_data.reviews_page_url ? "saswp-global-selected" : "") + '">Reviews</a>'),
            (o += "<a href=" + saswp_localize_data.collections_page_url + ' class="nav-tab ' + (saswp_localize_data.current_url == saswp_localize_data.collections_page_url ? "saswp-global-selected" : "") + '">Collections</a>'),
            (o += '<a class="nav-tab saswp-show-accept-rv-popup">Accept Reviews</a>'),
            (o += "</h2>"),
            (o += "</div>"),
            jQuery(jQuery(".wrap")).prepend(o);
    }
    jQuery(document).on("click", ".saswp-clear-images", function (a) {
        a.preventDefault();
        var e = s(this);
        1 == confirm("Are you sure? It will remove all the resized images") &&
            (e.addClass("updating-message"),
            s.ajax({
                type: "POST",
                url: ajaxurl,
        ...
        "saswp" == saswp_localize_data.post_type && "edit.php" == saswp_localize_data.page_now && jQuery(jQuery(".wrap a")[0]).after("<a href='" + saswp_localize_data.saswp_settings_url + "' id='' class='page-title-action'>Settings</a>"),
        "undefined" != typeof saswp_reviews_data &&
            s(".saswp-rating-div")
                .rateYo({
                    spacing: "5px",
        ...
        s("#sd-person-phone-number, #saswp_kb_telephone").focusout(function () {
            ...
            var e = s(this).val();
            /^\+([0-9]{1,3})\)?[-. ]?([0-9]{2,4})[-. ]?([0-9]{2,4})[-. ]?([0-9]{2,4})$/.test(e)
                ? a.parent().find(".saswp-phone-validation").remove()
                : a.after('<span style="color:red;" class="saswp-phone-validation">Invalid Phone Number</span>');
        }),
        saswpCollectionSlider(),
        s(document).on("click", ".saswp-add-rv-btn", function () {
        ...
        s(".saswp-rmv-coll-rv").on("click", function () {
            if (((rmv_boolean = !rmv_boolean), saswp_on_collection_design_change(), jQuery(jQuery(".saswp-add-dynamic-section")).remove(), rmv_boolean)) {
                var s = "";
                (s += '<div class="saswp-add-dynamic-section">'),
                    (s += '<div class="saswp-add-dynamic-btn">'),
                    (s += '<span class="dashicons dashicons-plus-alt saswp-add-rv-btn"></span>'),
                    (s += "</div>"),
                    (s += '<div class="saswp-dynamic-platforms" style="display:none;">'),
                    (s += '<select name="saswp_dynamic_platforms" id="saswp_dynamic_platforms"><option value="">Choose Platform</option>' + jQuery("#saswp-plaftorm-list").html() + "</select>"),
                    (s += "</div>"),
                    (s += "</div>"),
                    jQuery(jQuery(".saswp-collection-preview")[0]).after(s);
            }
        }),
        s(document).on("change", "#saswp_dynamic_platforms", function () {
            ...
            a &&
                jQuery.get(
                    ajaxurl,
                    { action: "saswp_add_to_collection", rvcount: "", platform_id: a, saswp_security_nonce: saswp_localize_data.saswp_security_nonce },
                    function (a) {
                        if (a.status && a.message) {
                            var e = "";
                            if (
                                (s.each(a.message, function (s, a) {
                                    e += '<option value="' + a.saswp_review_id + '">' + a.saswp_reviewer_name + " ( " + a.saswp_review_rating + " ) </option>";
                                }),
                                e)
                            ) {
                                var t = "";
                                (t += '<select id="saswp_dynamic_reviews_list" class="saswp-select2">'),
                                    (t += e),
                                    (t += "</select>"),
                                    (t += '<a class="button button-default saswp-add-single-rv">Add</a>'),
                                    s("#saswp_dynamic_platforms").nextAll().remove(),
                                    s("#saswp_dynamic_platforms").after(t),
                                    saswp_select2();
                            }
                        }
                    },
        ...
        s(document).on("click", ".saswp-opn-cls-btn", function () {
            s("#saswp-reviews-cntn").toggle(),
                s("#saswp-reviews-cntn").is(":visible")
                    ? (s(".saswp-onclick-show").css("display", "flex"), s(".saswp-onclick-hide").hide(), s(".saswp-open-class").css("width", "500px"))
                    : (s(".saswp-onclick-show").css("display", "none"), s(".saswp-onclick-hide").show(), s(".saswp-open-class").css("width", "300px"));
        }),
        s(".saswp-collection-display-method")
            .change(function () {
            ...
            .change(),
        s(document).on("click", ".saswp-remove-platform", function (a) {
            a.preventDefault();
        ...
        s(".saswp-coll-settings-options")
            .change(function () {
                saswp_grid_page = 1;
                var a = s(".saswp-collection-desing").val();
                s(".saswp-coll-options").addClass("saswp_hide"),
                    s(".saswp-collection-lp").css("height", "auto"),
                    s(".saswp-rmv-coll-rv").hide(),
                    s(".saswp-add-dynamic-section").hide(),
                    "grid" == a && (s(".saswp-grid-options").removeClass("saswp_hide"), s(".saswp-rmv-coll-rv").show(), s(".saswp-add-dynamic-section").show()),
                    "gallery" == a && s(".saswp-slider-options").removeClass("saswp_hide"),
                    "fomo" == a && (s(".saswp-fomo-options").removeClass("saswp_hide"), s(".saswp-collection-lp").css("height", "31px")),
                    "popup" == a && s(".saswp-collection-lp").css("height", "31px"),
                    saswp_on_collection_design_change();
            })
            .change(),
        s(".saswp-add-to-collection").on("click", function (a) {
            a.preventDefault();
            var e = s(this),
    ...
    var n,
        l,
        r = s("#saswp_total_reviews_list").val();
    r && saswp_get_collection_data(null, null, null, null, r),
        ((n = document.createElement("div")).style.cssText =
            "position:absolute; background:black; color:white; padding:4px 6px;z-index:10000;border-radius:2px; font-size:12px;box-shadow:3px 3px 3px rgba(0,0,0,.4);opacity:0;transition:opacity 0.3s"),
        (n.innerHTML = "Copied!"),
                ...
                "motivate" == a.className &&
                    ...
                    (function () {
                        ...
                        (function (s) {
                            var a = s || event;
                            clearTimeout(l),
                                (n.style.left = a.pageX - 10 + "px"),
                                (n.style.top = a.pageY + 15 + "px"),
                                (n.style.opacity = 1),
