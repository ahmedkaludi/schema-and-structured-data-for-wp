     ...
     saswp_enable_rating_review();                       
        ...
        //star rating stars here
            ...
            $(document).on("click",".saswp-fetch-s-approved-reviews", function(e){
                ...
                var token   = $("#saswp_s_approved_site_id").val();
                ...
                if(site_id && token){
                    ...
                    $.get(ajaxurl, 
                    { action:"saswp_fetch_s_approved_reviews",site_id:site_id,token:token,limit:limit,api_key:api_key, saswp_security_nonce:saswp_localize_data.saswp_security_nonce},
                     function(response){                                                                 
