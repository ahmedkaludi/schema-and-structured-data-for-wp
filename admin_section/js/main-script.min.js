    ...
    saswp_item_reviewed_call();
     ...
     saswp_enable_rating_review();                       
        ...
        //star rating stars here
            ...
            function saswp_fetch_s_approved_reviews(current, site_id, token, limit, api_key, page){
                current.addClass('updating-message');
                $.get(ajaxurl, 
                    { action:"saswp_fetch_s_approved_reviews",site_id:site_id,token:token,limit:limit,api_key:api_key,page:page, saswp_security_nonce:saswp_localize_data.saswp_security_nonce},
                     function(response){ 
                         current.removeClass('updating-message');
                         console.log(response);
                                      if(response['status'] =='t'){
                                      ...
                                      page++;
                                      if(page <5){
                                          saswp_fetch_s_approved_reviews(current, site_id, token, limit, api_key, page);
                                      }
