     ...
     saswp_enable_rating_review();                       
        ...
        //star rating stars here
            ...
            $(document).on("click", '.saswp-fetch-g-reviews', function(){          
              ...
              var place_id = $(this).parent().parent().find('.saswp-g-location-field').val();
                ...
                if(location !=''){
                    $.ajax({
                                  ...
                                  url:ajaxurl,                    
                                  dataType: "json",
                                  data:{action:"saswp_fetch_google_reviews",place_id:place_id, saswp_security_nonce:saswp_localize_data.saswp_security_nonce},
                                  success:function(response){    
                                      console.log(response['status']);                             
                                  },
                                  error: function(response){                    
